...
namespace SampleClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\anoua\Desktop\ML\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"C:\dotnet\SampleClassification\SampleClassification.Model\MLModel.zip";
